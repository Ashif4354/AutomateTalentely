...
# This applicaiotn does not select correct answers or any answers at all
# It waits for the completion time and ends the test , this repeats for all tests
...
# If you close the application or the browser window at any time, dont worry, the application can continue from the same point. progress will not reset.
